...
const webpackConfig = require("./webpack.config.js"),
	...
	paths = {
		...
		fonts: {
			src: "./src/fonts/**/*.{ttf,eot,otf,woff,woff2}",
			dist: "./dist/fonts/",
...
export const development = gulp.series(cleanFiles,
	gulp.parallel(views, styles, scripts, images, webpimages, fonts, favs, sprite),
	gulp.parallel(server));

export const prod = gulp.series(cleanFiles, serverConfig, views, styles, scripts, images, webpimages, fonts, favs, sprite);
